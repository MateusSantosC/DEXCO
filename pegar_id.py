...
class pegar_id:
    ...
    def base():
        os.startfile("Base\pegar_id.xlsx")
    ...
    def pegar():
        ...
        try:
            ...
            options.add_argument(f"user-data-dir=C:\\Users\\gmagalha\\AppData\\Local\\Google\\Chrome\\User Data")
            time.sleep(2)
            ...
            # Abrir tabela exel
            tabela = pd.read_excel("Base\pegar_id.xlsx")
            ...
            for linha in tabela.index:
                ...
                try:  
                    ...
                    print(id_nota)
                    tabela.to_excel("Base\pegar_id2.xlsx", index = False)
            
                
                except:
                    print("Erro no for")
                    break
            os.startfile("Base\pegar_id2.xlsx")
        except:
