...
layout = [
    ...
    [sg.Text('DEXCO', font = ('Helvetica', 60), text_color = 'WHITE')],
    ...
    [sg.Text('', font = ('Helvetica', 12), key = 'msg2')],
    
    [sg.Text('')],
    [sg.Text('')],
    
    
    [sg.Button('PEGAR ID',size = (13,2), font = ('Helvetica', 12)),sg.Text(''),sg.Button('EXTRAIR DESCRIÇÃO',size = (13,2), font = ('Helvetica', 12))],
    
    
    [sg.Text('')],
    
    [sg.Button('MOVER PROCESSO',size = (13,2), font = ('Helvetica', 12)),sg.Text(''),sg.Button('ANALISAR INBOUND',size = (13,2), font = ('Helvetica', 12))],
